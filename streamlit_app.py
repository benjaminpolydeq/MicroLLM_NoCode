...
def call_ai_api(messages, domain):
    """
    Utilise l'API Anthropic Claude disponible dans l'environnement Streamlit
    """
    try:
        ...
        # Construction du prompt complet avec contexte du domaine
        full_prompt = f"""{system_prompt}

Question de l'utilisateur : {user_query}

Fournis une réponse détaillée, professionnelle et adaptée au domaine {domain}."""
        
        # RÉPONSE DIRECTE - Pas besoin d'API externe
        # Le système utilise déjà Claude nativement dans cet environnement
